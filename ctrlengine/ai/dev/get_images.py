...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-width', '--width', help='Specifies the width of the image being captured (default 640px)', type=int
    )
    parser.add_argument(
        '-height', '--height', help='Specifies the height of the image being captured (default 480px)', type=int
    )
