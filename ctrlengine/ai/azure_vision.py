...
class azure_vision:
    ...
    def __init__(self, api_key=None, api_endpoint=None):
        ...
        self.headers = {'Ocp-Apim-Subscription-Key': api_key, 'Content-Type': 'application/octet-stream'}
        self.response = None
        self.analysis = None
    ...
    def __run_analysis(self, image, params):
        ...
        self.response = requests.post(self.url, headers=self.headers, params=params, data=image)
